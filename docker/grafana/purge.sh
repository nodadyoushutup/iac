...
# Removes Docker assets that belong to the Grafana deployment (services, configs,
# secrets, containers, networks, volumes, images) without touching unrelated resources.
