...
#     depends_on = [
#         proxmox_virtual_environment_download_file.talos_cp_1,
...
#         discard = "on"
#         file_format = "raw"
#         file_id = proxmox_virtual_environment_download_file.talos_cp_1.id
#         interface = "scsi0"
#         iothread = false
#         replicate = true
#         serial = null
...
#         discard = "on"
#         file_format = "raw"
#         file_id = proxmox_virtual_environment_download_file.talos_cp_2.id
#         interface = "scsi0"
#         iothread = false
#         replicate = true
#         serial = null
...
# resource "proxmox_virtual_environment_vm" "talos_cp_3" {
#     depends_on = [
#         proxmox_virtual_environment_download_file.talos_cp_1,
#         proxmox_virtual_environment_file.cloud_config
#     ]
...
#         discard = "on"
#         file_format = "raw"
#         file_id = proxmox_virtual_environment_download_file.talos_cp_3.id
#         interface = "scsi0"
#         iothread = false
#         replicate = true
#         serial = null
...
#     depends_on = [
#         proxmox_virtual_environment_download_file.talos_wk_1,
#         proxmox_virtual_environment_file.cloud_config
#     ]
...
#         discard = "on"
#         file_format = "raw"
#         file_id = proxmox_virtual_environment_download_file.talos_wk_1.id
#         interface = "scsi0"
#         iothread = false
#         replicate = true
#         serial = null
